...
def model_pred_label():
    ...
    doc_positive_in  = doc_positive_input_list[0]
    doc_negative_in = doc_negative_input_list[0]
    query_y,doc_positive_y,doc_negative_y = model(query_in,doc_positive_in,doc_negative_in,False)
...
"is_norm":is_norm,"query_BS",query_BS}
log_name_list = ["summaries_dir","model_dir","gpu_num","learning_rate","step_num","restep_num","print_cycle","wfreq_flag","ngram_flag",
"loss_type","distance_type","optimizer_type","model","layer1_hidden","layer2_hidden","is_norm","query_BS"]
